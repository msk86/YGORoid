...
import org.msk86.ygoroid.newaction.dueldisk.actionimpl.IndicatorDecreaseAction;
import org.msk86.ygoroid.newaction.dueldisk.actionimpl.IndicatorIncreaseAction;
        ...
        if(item != null) {
            if(op.getContainer() instanceof Field) {
                ...
                if(field.getType() == FieldType.MONSTER || field.getType() == FieldType.MAGIC_TRAP
                        ...
                        || field.getType() == FieldType.EX_DECK) {
