...
public class LifePoint implements SelectableItem, Drawable {
    ...
    private void createDialog() {
        ...
        dialog = new AlertDialog.Builder(Utils.getContext())
                .setTitle(Utils.s(R.string.INPUT_LP))
                .setPositiveButton(Utils.s(R.string.CONFIRM_YES), new OnLPClickListener(this, "OK"))
                .setNegativeButton(Utils.s(R.string.CONFIRM_NO), new OnLPClickListener(this, "Cancel"))
                .create();
