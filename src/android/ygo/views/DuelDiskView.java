...
public class DuelDiskView extends View {
    ...
    private void initDuelDiskTest() {
        ...
        // set magic
        Card setMagicCard = new Card("35952884", null, CardType.MAGIC, true, true);
        Field f = duelFields.getMagicField(2);
        f.setItem(setMagicCard);

        // Monsters
        // set
        Card setCard = new Card("35952884", null, CardType.SYNC_MONSTER, false, true);
        f = duelFields.getMonsterField(0);
        f.setItem(setCard);
        // atk monster
        Card card = new Card("35952884", null, CardType.SYNC_MONSTER, true, false);
        f = duelFields.getMonsterField(1);
        f.setItem(card);
        // xyz + 2m
        Card material1 = new Card("35952884", null, CardType.SYNC_MONSTER, false, true);
        Card material2 = new Card("35952884", null, CardType.SYNC_MONSTER, false, true);
        Card xyzCard = new Card("84013237", null, CardType.XYZ_MONSTER, true, false);
        ...
        f.setItem(overlay);
        // xyz + 1m
        Card material21 = new Card("35952884", null, CardType.SYNC_MONSTER, false, true);
        Card material22 = new Card("35952884", null, CardType.SYNC_MONSTER, false, true);
        Card xyzCard2 = new Card("84013237", null, CardType.XYZ_MONSTER, false, false);
        ...
        f.setItem(overlay2);
        // 2m
        Card material31 = new Card("35952884", null, CardType.SYNC_MONSTER, false, true);
        Card material32 = new Card("35952884", null, CardType.SYNC_MONSTER, false, false);
        ...
        Card usedCard = new Card("35952884", null, CardType.SYNC_MONSTER, false, true);
        graveyard.push(usedCard);

        CardList removed = (CardList) duelFields.getRemovedField().getItem();
        Card removedCard = new Card("84013237", null, CardType.XYZ_MONSTER, false, true);
        removed.push(removedCard);

        List<Card> hands = new ArrayList<Card>();
        hands.add(new Card("84013237", null, CardType.SYNC_MONSTER, false, true));
        hands.add(new Card("35952884", null, CardType.SYNC_MONSTER, false, true));
        hands.add(new Card("35952884", null, CardType.SYNC_MONSTER, false, true));
        hands.add(new Card("84013237", null, CardType.SYNC_MONSTER, false, true));
        hands.add(new Card("35952884", null, CardType.SYNC_MONSTER, false, true));
        hands.add(new Card("84013237", null, CardType.SYNC_MONSTER, false, true));
